...
class __TwigTemplate_c3a071a02be081b94f2699130694fc2c7036804f6ff81f151103a486ac974200 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container mt-5\">
        ...
        echo "</td>
            ...
            ";
        // line 52
        if (((isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 52, $this->source); })()) === twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 52, $this->source); })()), "user", [], "any", false, false, false, 52))) {
            // line 53
            echo "                <div class=\"mt-3\">
                    <a href=\"";
            // line 54
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("account_profile");
            echo "\" class=\"btn btn-primary\">Modify my information</a>
                    <a href=\"";
            // line 55
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("account_password");
            echo "\" class=\"btn btn-primary\">Modify my password</a>
                </div>
            ";
        }
        // line 58
...
";
    ...
    {
        return array (  166 => 58,  160 => 55,  156 => 54,  153 => 53,  151 => 52,  144 => 48,  137 => 44,  130 => 40,  123 => 36,  91 => 6,  81 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Page of {{ user.firstName }} {{ user.lastName }}{% endblock %}
    ...
    <div class=\"container mt-5\">
        ...
        <div class=\"container col-6 mt-4\">
            ...
            {% if user is same as(app.user) %}
                <div class=\"mt-3\">
                    <a href=\"{{ path('account_profile') }}\" class=\"btn btn-primary\">Modify my information</a>
                    <a href=\"{{ path('account_password') }}\" class=\"btn btn-primary\">Modify my password</a>
                </div>
            {% endif %}
        </div>
    </div>
{% endblock %}
", "user/index.html.twig", "Z:\\xampp\\htdocs\\Contact\\templates\\user\\index.html.twig");
    }
}
